package com.tpj.packinglist.repository;


import com.tpj.packinglist.domain.PersistentAuditEvent;
 ...
 */
public interface PersistenceAuditEventRepository1 extends JpaRepository<PersistentAuditEvent, Long> {
